...
@EnableJpaRepositories(basePackages = "org.projw.blackserver")
@EnableScheduling
public class RootConfig {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.physical_naming_strategy", "org.projw.blackserver.config.ImprovedNamingStrategy");
